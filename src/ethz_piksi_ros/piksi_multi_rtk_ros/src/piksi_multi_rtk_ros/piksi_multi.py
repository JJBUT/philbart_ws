...
class PiksiMulti:
    ...
    def cb_sbp_pos_llh(self, msg_raw, **metadata):
        ...
        # Differential GNSS (DGNSS)
            ...
            return
        #JACK: make it so that both RTK fix and float messages get pubished under the rtk_fix topic
        # RTK messages.
        ...
        elif (msg.flags == PosLlhMulti.FIX_MODE_FIX_RTK or msg.flags == PosLlhMulti.FIX_MODE_FLOAT_RTK):
        ...
        #JACK: inlude Float RTK as rtk_mode_fix option
        self.receiver_state_msg.rtk_mode_fix = True if (msg.flags == PosLlhMulti.FIX_MODE_FIX_RTK or msg.flags == PosLlhMulti.FIX_MODE_FLOAT_RTK) else False
